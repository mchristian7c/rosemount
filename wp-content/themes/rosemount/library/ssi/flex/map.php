    ...
    "stylers": [
      {
        "color": "#9e9e9e"
				...
				var image = {
					url: 'https://www.rosemount-ifa.co.uk/wp-content/themes/rosemount/library/images/pin.png',
					scaledSize: new google.maps.Size(25, 37), // scaled size
			    origin: new google.maps.Point(0,0), // origin
			    anchor: new google.maps.Point(12,37) // anchor
				}
				var codfanglers = new google.maps.Marker({
					position: {lat: <?php the_field('lat', 'option'); ?>, lng: <?php the_field('long', 'option'); ?>},
					map: map,
					icon: image,
				});
			}
