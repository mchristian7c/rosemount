<?
    // Instagram API URI
    $images_uri = "https://api.instagram.com/v1/users/" . get_field('instagram_user_id_chapel', 'options') . "/media/recent/?access_token=" . get_field('instagram_access_token_chapel', 'options') . '&count=' . get_field('picture_count_chapel', 'options');
    $user_uri = "https://api.instagram.com/v1/users/" . get_field('instagram_user_id_chapel', 'options') . "/?access_token=" . get_field('instagram_access_token_chapel', 'options');
