...
add_action( 'after_switch_theme', 'team_flush_rewrite_rules' );

// Flush your rewrite rules
function team_flush_rewrite_rules() {
	flush_rewrite_rules();
}
...
function team() {
	...
	register_post_type( 'team', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'edit' => __( 'Edit Team Member', 'bonestheme' ), /* Edit Dialog */
			...
			'description' => __( 'team', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
	...
	*/
	...
	// 	array('video-blog'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
	...
	// 		'labels' => array(
	// 			'name' => __( 'Team Member Tags', 'bonestheme' ), /* name of the custom taxonomy */
	// 			'singular_name' => __( 'Team Member Tag', 'bonestheme' ), /* single taxonomy name */
	// 			'search_items' =>  __( 'Search Team Member Tags', 'bonestheme' ), /* search title for taxomony */
	// 			'all_items' => __( 'All Team Member Tags', 'bonestheme' ), /* all title for taxonomies */
	// 			'parent_item' => __( 'Parent Team Member Tag', 'bonestheme' ), /* parent title for taxonomy */
	// 			'parent_item_colon' => __( 'Parent Team Member Tag:', 'bonestheme' ), /* parent taxonomy title */
	// 			'edit_item' => __( 'Edit Team Member Tag', 'bonestheme' ), /* edit custom taxonomy title */
	// 			'update_item' => __( 'Update Team Member Tag', 'bonestheme' ), /* update title for taxonomy */
	// 			'add_new_item' => __( 'Add New Team Member Tag', 'bonestheme' ), /* add new title for taxonomy */
	// 			'new_item_name' => __( 'New Team Member Tag Name', 'bonestheme' ) /* name title for taxonomy */
	// 		),
	// 		'show_admin_column' => true,
	// 		'show_ui' => true,
	// 		'query_var' => true,
