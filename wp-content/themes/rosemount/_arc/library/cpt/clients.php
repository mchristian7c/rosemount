...
add_action( 'after_switch_theme', 'videos_flush_rewrite_rules' );

// Flush your rewrite rules
function videos_flush_rewrite_rules() {
	flush_rewrite_rules();
}
...
function videos() {
	...
	register_post_type( 'video-blog', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Video Posts', 'bonestheme' ), /* This is the Title of the Group */
	...
	*/
	...
	register_taxonomy( 'videos_category',
