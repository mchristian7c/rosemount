...
if ("undefined" == typeof jQuery) throw new Error("Jasny Bootstrap's JavaScript requires jQuery"); + function(a) {
    ...
    b.DEFAULTS = {
        ...
        var b = a("body").width(),
            ...
            // added some custom shit - , a('body').addClass('sheet')
        if (void 0 === a("body").data("offcanvas-style") && a("body").data("offcanvas-style", a("body").attr("style") || ""), a("body").css("overflow", "hidden"), a('body').addClass('sheet'), a("body").width() > b) {
        ...
        if ("slid" === this.state) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                var c = a(".canvas-slid"),
                    ...
                    e = function() {
                      // added some custom shit - , a('body').removeClass('sheet')
                        "slide-out" == this.state && (this.state = null, this.placement = null, this.$element.removeClass("in"), c.removeClass("canvas-sliding"), a('body').removeClass('sheet'), c.add(this.$element).add("body").each(function() {
